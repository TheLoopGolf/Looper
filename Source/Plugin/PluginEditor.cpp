...
LooperAudioProcessorEditor::~LooperAudioProcessorEditor() = default;

void LooperAudioProcessorEditor::paint(juce::Graphics& g) { g.fillAll(juce::Colour(0xff0e0e10)); }
...
void LooperAudioProcessorEditor::handleImport(const juce::Array<juce::File>& files)
{
    ...
    {
        // Pref Off: accept immediately and stay on main play view
